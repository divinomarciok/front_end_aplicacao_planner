...
export function App() {
  ...
  const [emailsToInvite, setEmailsToInvite] = useState([
    'divino.souza@tecnospeed.com', 'teste@gmail.com'
  ])
        ...
        <div className="space-y-4">
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            ...
            <div className="flex items-center gap-2 flex-1">
              ...
              <input type="text" disabled={isGuestInputOpen} placeholder="Para onde você vai?" className="bg-transparent text-lg placeholder-zinc-400 outline-none flex-1" />
            </div>
            <div className="flex items-center gap-2 w-">
              <Calendar className="size-5 text-zinc-400" />
              <input type="text" disabled={isGuestInputOpen} placeholder="Quando?" className="bg-transparent text-lg placeholder-zinc-400 w-40 outline-none" />
            </div>
            ...
            {isGuestInputOpen ? (
              <button onClick={closeGuestsInput} className="flex items-center bg-zinc-800 text-zinc-200 rounded-lg px-5 py-2 font-medium gap-2 hover:bg-zinc-700" >
                Alterar local/data
                <Settings2 className="size-5" />
              </button>
            ) : (
              <button onClick={openGuestsInput} className="flex items-center bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium gap-2 hover:bg-lime-400">
                Continuar
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            ...
            <div className="w-full h-px bg-zinc-800 ">
              ...
              <form onSubmit={addNewEmailToInvite}className="py-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2">
                ...
                <div className="px-2 flex items-center flex-1 gap-2">
                  ...
                  <input
                    type="email"
                    name="email"
                    placeholder="Digite e-mail do convidado?"
